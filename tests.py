...
class test_port(unittest.TestCase):
    def test(self):
        ...
        # time.sleep(5)
        # print("\n---------------------PROCEED TEST---------------------\n\n")
        # test_scenario(['55006', 'amit', '6', 'test.log', '7', '2'], "User amit downloaded 100% out of file. Last byte is: ")
        ...
        # FIX
        # print("\n-----------------INVALID USER TEST------------------\n\n")
        # test_scenario(['hi', '55012', 'amit', '3', 'neta', '2'], "The name you chose is not in the chatroom!")
        # time.sleep(5)

        # FIX
        print("\n-----------------INVALID FILE NAME TEST------------------\n\n")
        test_scenario(['hi', '55013' 'amit', '6', 'Hello.txt', 'q', '2'], "Please enter requested file name or 'q' to "
                                                                          "quit: ")
